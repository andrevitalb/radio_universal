...
function setButtonPosition() {
    if ($(window).width() > 767 && $(".swiper-auto-height-container").length > 0) {
        var leftPosition = parseInt($('.swiper-auto-height-container .swiper-slide-active').css('padding-left'));
        var bottomPosition = parseInt($('.swiper-auto-height-container .swiper-slide-active').css('padding-bottom'));
...
$(document).ready(function () {
    ...
    $(document).on("click", '#contact-us-button', function () { 
        ...
        if (error) {
            $.ajax({
                type: "POST",
                url: "assets/email-templates/contact.php",
    ...
    $(document).on("click", '#project-contact-us-button', function (e) {
        ...
        if (error) {
            $.ajax({
                type: "POST",
                url: "assets/email-templates/project-contact.php",
